...
public class LearnFromAppFragment
        extends AbstractLearnFragment
        implements IAsyncTaskResultClient,
        IRefreshable,
        ILearnFragmentUiEventHandler {

    public static final String TAG = LearnFromAppFragment.class.getSimpleName();
    ...
    public static AbstractLearnFragment newInstance() {
        AbstractLearnFragment fragment = new LearnFromAppFragment();
